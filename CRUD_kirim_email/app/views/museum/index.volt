			  ...
			  <div class="modal-dialog modal-md modal-80p">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">            
			        <form class="form-horizontal" method="POST" action="{{ url('museum/update') }}">
			              ...
			              <div class="form-group">
			                ...
			                <div class="col-sm-3">
			                    <select class="form-control" name="jenis">
			                      	<option value="personal" {% if data.jenis is 'personal' %} selected {% endif %}>Personal</option>
			    					<option value="kelompok" {% if data.jenis is 'kelompok' %} selected {% endif %}>Kelompok</option>
			                    </select>
			                </div>
